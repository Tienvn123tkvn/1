...
local Window = OrionLib:MakeWindow({Name = "KAIGM HUB", HidePremium = false, IntroText = "KAIGM HUB", SaveConfig = true, ConfigFolder = "KAIGAMING"})
----------Tab-----------------------
...
M:AddToggle({
    Name = "stops automatically when there is a cup",
    Default = false,
...
spawn(function()
    while wait() do
        pcall(function()
            Bone:Set("still : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
        end)
    end
end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
					BoSs:Set("Status Boss : Have")	
				else
					BoSs:Set("Status Boss : Not available")	
				end
			end)
        end
	end)
...
elseif World3 then
	tableBoss = {"KAIGM Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
...
spawn(function()
    ...
    M:AddToggle({
        Name = "auto plow observation haki",
        Default = false,
    ...
    Callback = function(Value)
        ...
        if _G.TeleportIsland == true then
            repeat wait()
                ...
                elseif _G.SelectIsland == "Noen Islands" then
